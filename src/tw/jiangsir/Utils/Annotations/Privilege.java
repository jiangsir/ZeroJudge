...
public @interface Privilege {
	Class<? extends HttpServlet>[] add_ProblemManager() default { CheckProblemServlet.class,
			EditProblemsServlet.class, UpdateProblemServlet.class, DeprecateProblemServlet.class,
			ProblemApiServlet.class, PreJudgeAjax.class, UpdateForumServlet.class,
			SubmissionsServlet.class };
...
//			SystemMonitorServlet.class, InsertUsersServlet.class};
	...
	Class<? extends HttpServlet>[] add_VClassManager() default { EditVClassesServlet.class,
			InsertVClassServlet.class, UpdateVClassServlet.class, InsertStudentsServlet.class,
			InsertUsersServlet.class, ShowVClassServlet.class, VClassContestServlet.class,
			RemoveVClassStudentServlet.class, DeleteVClassServlet.class, RebuiltVClassServlet.class,
			InsertVContestServlet.class };

	Class<? extends HttpServlet>[] add_ContestManager() default { InsertContestServlet.class,
			EditContestsServlet.class, RebuiltContestServlet.class, InsertContestServlet.class,
	 ...
	 * @return
	 */
	Class<? extends HttpServlet>[] remove_UserInContest() default { ShowCodeServlet.class,
			ShowSessionsServlet.class, NewThreadServlet.class, ShowThreadServlet.class,
			ReplyServlet.class, ShowIMessagesServlet.class, SendIMessageServlet.class,
