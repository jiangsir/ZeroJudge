...
public class MyRequestListener implements ServletRequestListener {
	...
	public void requestInitialized(ServletRequestEvent event) {
		...
		if (!request.getRequestURL().toString().endsWith(".js")
				&& !request.getRequestURL().toString().endsWith(".css")) {
			logger.info(
					"requestURL:" + request.getMethod() + ":" + request.getRequestURL() + "?" + request.getQueryString()
							+ ", onlineUser:" + sessionScope.getOnlineUser() + ", ip:" + request.getRemoteAddr());
		}
	}
