...
//				new RunCommand().exec("sudo python3 " + ApplicationScope.getAppConfig().getScriptsPath() + File.separator
//						+ "InitializedListener.py " + appConfig.getRsyncAccount() + " " + appConfig.getConsolePath());
//				new RunCommand().exec("sudo python3 " + ApplicationScope.getAppRoot().getAbsolutePath() + File.separator
//						+ "InitializedListener.py " + appConfig.getRsyncAccount() + " " + appConfig.getConsolePath());
				new RunCommand().exec("sudo " + ApplicationScope.getAppConfig().getBinPath() + File.separator
						+ "InitializedListener.py " + appConfig.getRsyncAccount() + " " + appConfig.getConsolePath());
			} else {
