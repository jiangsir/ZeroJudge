...
public class InfoException extends RuntimeException {
	...
	public InfoException(String title, String subtitle, String content, ArrayList<String> list) {
		super(title, new Alert(Alert.TYPE.INFO, title, subtitle, content, list, null, null,
