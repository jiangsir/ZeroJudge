...
public class UserApiServlet extends HttpServlet implements IAccessFilter {
	...
	public void doPost_searchUsers(HttpServletRequest request, HttpServletResponse response) {
		try {
			String keyword = request.getParameter("keyword");
			ArrayList<User> users = new UserService().getUsersByKeyword(keyword);
	...
	public void doPost_deleteUser(HttpServletRequest request, HttpServletResponse response) {
		try {
			int userid = Integer.parseInt(request.getParameter("userid"));
