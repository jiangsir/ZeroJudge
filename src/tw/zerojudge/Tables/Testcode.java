...
public class Testcode {
	...
	public void doCreateTestfile(int solutionid) throws IOException {
		...
		FileTools.writeStringToFile(new File(appConfig.getTestdataPath(), getTESTDATA_FILENAME(solutionid) + ".in"),
				getIndata());
		FileTools.writeStringToFile(new File(appConfig.getTestdataPath(), getTESTDATA_FILENAME(solutionid) + ".out"),
				getOutdata());
	}
