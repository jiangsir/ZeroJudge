...
public class Contestant {
	...
	public boolean getIsNull() {
		if (this.getId().intValue() == new Contestant().getId().intValue()) {
			return true;
		}
		return false;
	}
	...
	public void setTeamaccount(String teamaccount) {
		if (teamaccount == null || "".equals(teamaccount.trim())) {
			return;
		}
	...
	@JsonIgnore
	public boolean getIsStatusFinish() {
		return this.getStatus() == STATUS.finish;
	}

	@JsonIgnore
	public boolean getIsStatusLeave() {
		return this.getStatus() == STATUS.leave;
	}

	@JsonIgnore
	public boolean getIsStatusKicked() {
		return this.getStatus() == STATUS.kicked;
	}
	...
	/**
	 * 將 contestant 轉為 student
	 * 
	 * @return
	 */
	@JsonIgnore
	public VClassStudent toStudent() {
		Contest contest = new ContestService().getContestById(contestid);
		if (contest.isVContest()) {
			return new VClassStudentDAO().getStudent(contest.getVclassid(), userid);
		} else
