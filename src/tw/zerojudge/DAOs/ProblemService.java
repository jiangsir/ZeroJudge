...
public class ProblemService {
	 ...
	 * @throws IOException
	 */
	public Problem InsertProblemByExportProblem(int ownerid, ExportProblem exportProblem) throws IOException {
	 ...
	 * @throws IOException
	 */
	public Problem ImportProblemByJsonfile(int ownerid, File file)
			throws JsonParseException, JsonMappingException, IOException {
		ObjectMapper mapper = new ObjectMapper(); 
		ExportProblem exportProblem = mapper.readValue(file, ExportProblem.class);
		return this.InsertProblemByExportProblem(ownerid, exportProblem);
	}
