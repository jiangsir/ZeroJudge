...
public class SolutionService {
	 ...
	 * @return
	 */
	public ArrayList<Solution> getSolutionsByCodelocker(HttpSession session, int codelocker,
			int pagenum) {
	 ...
	 * @return
	 */
	public ArrayList<Solution> getSolutionsByJudgement(ServerOutput.JUDGEMENT judgement,
			int pagenum) {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("visible=" + Solution.VISIBLE.open.getValue());
	 ...
	 * @return
	 */
	public ArrayList<Solution> getSolutionsByProblemidLanguage(Problemid problemid,
			Language language, int pagenum) {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("visible=" + Solution.VISIBLE.open.getValue());
	...
	public ArrayList<Solution> getSolutionsByUseridContestid(int userid, int contestid, int page) {
		...
		solutionids
				.removeAll(new ContestService().getContestById(contestid).getRemovedsolutionids());
		ArrayList<Solution> solutions = new ArrayList<Solution>();
	...
	public ArrayList<Solution> getSolutionsByPidUseridSolutionid(int pid, int userid,
			int solutionid) {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("pid=" + pid);
		rules.add("userid=" + userid);
	 ...
	 */
	public ArrayList<Solution> getSolutionsByProblemidJudgement(Problemid problemid,
			ServerOutput.JUDGEMENT judgement, int page) throws DataException {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("visible=" + Solution.VISIBLE.open.getValue());
		rules.add("pid=" + new ProblemService().getProblemByProblemid(problemid).getId());
		rules.add("judgement=" + judgement.ordinal());
	 ...
	 * @throws DataException
	 */
	public ArrayList<Solution> getSolutionsByPidUserid(String account, Problemid problemid,
	 ...
	 * @return
	 */
	public ArrayList<Solution> getSolutions(String account, ServerOutput.JUDGEMENT judgement,
			Problemid problemid, int page) {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("userid=" + new UserService().getUserByAccount(account).getId());
		rules.add("judgement=" + judgement.ordinal());
		rules.add("pid=" + new ProblemService().getProblemByProblemid(problemid).getId());
	 ...
	 * @return
	 */
	public ArrayList<Solution> getSolutionsByUseridJudgement(Integer userid,
			ServerOutput.JUDGEMENT judgement, int page) {
		TreeSet<String> rules = new TreeSet<String>();
		rules.add("userid=" + userid);
		rules.add("judgement=" + judgement.ordinal());
		rules.add("visible=" + Solution.VISIBLE.open.getValue());
	...
	public synchronized void insertInitSolutions() {
		...
		for (Compiler compiler : ApplicationScope.getAppConfig().getServerConfig()
				.getEnableCompilers()) {
