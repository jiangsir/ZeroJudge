...
import tw.zerojudge.Configs.AppConfig.BITCONFIG;
...
public class EditAppConfigServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		AppConfig appConfig = ApplicationScope.reloadAppConfig();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String rejudgeable = request.getParameter("rejudgeable");
			String registerable = request.getParameter("registerable");
			String applyTeacher = request.getParameter("applyTeacher");
			String applyProblemManager = request.getParameter("applyProblemManager");
			appConfig.doAssignConfig(BITCONFIG.rejudgeable, Boolean.parseBoolean(rejudgeable));
			appConfig.doAssignConfig(BITCONFIG.registerable, Boolean.parseBoolean(registerable));
			appConfig.doAssignConfig(BITCONFIG.applyTeacher, Boolean.parseBoolean(applyTeacher));
			appConfig.doAssignConfig(BITCONFIG.applyProblemManager, Boolean.parseBoolean(applyProblemManager));
