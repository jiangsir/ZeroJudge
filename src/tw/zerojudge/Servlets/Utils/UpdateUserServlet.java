...
public class UpdateUserServlet extends HttpServlet implements IAccessFilter {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String CSRFToken = TokenTool.generateCSRFToken();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String csrfTokenFromSession = (String) request.getSession().getAttribute("CSRF_TOKEN");
			if (!csrfTokenFromRequest.equals(csrfTokenFromSession)) {
				throw new JQueryException("token有誤。");
			}
