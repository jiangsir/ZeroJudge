...
public class ApplicationServlet extends ZJServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		onlineUser.setConfig(onlineUser.enableConfig(User.CONFIG.ContestManager));
		onlineUser.setConfig(onlineUser.enableConfig(User.CONFIG.InsertProblem));
		onlineUser.setConfig(onlineUser.enableConfig(User.CONFIG.ProblemLevelManager));
		onlineUser.setConfig(onlineUser.enableConfig(User.CONFIG.QualifiedAuthor));
