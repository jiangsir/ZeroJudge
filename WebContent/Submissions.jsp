		...
		<div class="row">
			<ul class="nav nav-tabs" role="tablist">
				...
				<c:forEach var="compiler"
					...
					varStatus="varstatus">
					<li><a
						href="?language=${compiler.language}${querystring}#aria_${compiler.language}"
						aria-controls="aria_${compiler.language}" role="presentation">${compiler.language}</a>
					</li>
				</c:forEach>

				<c:if test="${sessionScope.onlineUser.isDEBUGGER}">
					<li><a href="?status=RF" aria-controls="aria_RF"
						role="presentation">RF</a></li>
					<li><a href="?status=SE" aria-controls="aria_SE"
						role="presentation">SE</a></li>
					<li><a href="?status=Waiting" aria-controls="aria_Waiting"
						role="presentation">Waiting</a></li>
