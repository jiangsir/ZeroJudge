	...
	<div class="container">
		<div class="row">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#monitor"
					aria-controls="monitor" role="tab" data-toggle="tab">系統監視器</a></li>
			</ul>
						...
						<div role="tabpanel" class="tab-pane active" id="appconfig">
							...
							<table class="table table-hover">
								...
								<tr>
									...
									<td>
										<div class="radio">
											<label> <input name="systemMode" type="radio"
												value="TRAINING_MODE"
										...
										<div class="radio">
											<label> <input name="systemMode" type="radio"
												value="CLASS_MODE" data-systemmode="${appConfig.systemMode}" />
												開課模式(只有開課模組)
											</label>
										</div>
										<div class="radio">
										...
										<div class="radio">
											<label><input name="systemMode" type="radio"
												value="CLOSE_MODE" data-systemmode="${appConfig.systemMode}" />
...
--%>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											...
											<label for="SystemMailPassword"
												class="col-sm-2 control-label"> 應用程式密碼</label>
											<div class="col-sm-10">
												<input type="text" class="form-control"
						...
						<div role="tabpanel" class="tab-pane" id="banners">
							<table class="table table-hover">
								<c:forEach var="banner" items="${appConfig.banners}">
									<tr>
										<td>出現比率：<input value="${banner.percent }" type="text"
											name="percent" maxlength="3" size="3"></input>%<br> <textarea
												name="bannerContent" rows="5" style="min-width: 100%">${banner.content}</textarea>
										</td>
									</tr>
								</c:forEach>
							</table>
						...
						<div role="tabpanel" class="tab-pane" id="monitor">
							...
							<table class="table table-hover">
								...
								<c:forEach var="judgeObject"
									items="${appConfig.getJudgeQueue()}" varStatus="status">
									<tr>
										<th>${status.count}</th>
										<td>${judgeObject.solution.id}</td>
										<td><a
											href="./ShowContest?contestid=${judgeObject.solution.contestid}">${judgeObject.solution.contestid}</a></td>
										<td>${judgeObject.problem.problemid}:${judgeObject.problem.title}</td>
										<td><a
											href="./UserStatistic?id=${judgeObject.solution.user.id}">${judgeObject.solution.user.account}</a></td>
