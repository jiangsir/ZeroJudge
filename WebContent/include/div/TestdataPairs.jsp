...
<form
			...
			<div id="testdataPair">
				<div>
					...
					<input name="scores" type="text" id="score" size="3" maxlength="3"
						...
						type="text" id="timelimits" size="3" maxlength="3"
 ...
 --%>
		...
		<br /> 總分：<span id="totalscore"></span> 分 <span id="averagescore"
			...
			class="btn btn-default">自動配時</span><span id="set100ms"
			class="btn btn-default">0.1s</span><span id="set200ms"
			class="btn btn-default">0.2s</span><span id="set500ms"
			class="btn btn-default">0.5s</span> <br /> <br /> <input
			name="writeScoresTimelimits" class="btn btn-success btn-lg col-md-12"
			value="儲存配分、配時" />
	</div>
