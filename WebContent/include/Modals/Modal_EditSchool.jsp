			...
			<div class="modal-body">
				<form class="form-horizontal">
					<div class="form-group">
						<label for="tname" class="col-sm-3 control-label">學校id：</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="schoolid"
								name="schoolid" value="${fn:escapeXml(school.id)}" readonly>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="tname" class="col-sm-3 control-label">教育部學校代碼：</label>
						<div class="col-sm-9">
							<input id="schoolid" name="schoolid" type="hidden"
								value="${param.schoolid }" /> <input type="text"
								class="form-control" id="tname" name="schoolsn"
								placeholder="請輸入教育部學校代碼"
								value="${fn:escapeXml(school.schoolsn)}">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="checkbox" name="checkid" value="1"
								data-checkid="${school.checkid}"> 資料正確請勾選<br>
							校名及網址確認之後才會出現在『學校清單』當中。
						</div>
					</div>
