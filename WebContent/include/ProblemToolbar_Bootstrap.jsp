...
<c:if test="${sessionScope.onlineUser.isCanUpdateProblem(problem)}">
	<div id="ProblemToolbar" data-problemid="${problem.problemid}">
		...
		<%--
		<select name="problemdisplay" data-problemdisplay="${problem.display}"
			data-problemid="${problem.problemid}" class="form-control">
			<option value="---">---</option>
 ...
 --%>
		<div class="btn-group btn-group-sm" role="group" aria-label="...">
			<select class="btn btn-default" name="problemdisplay"
			...
			<c:if test="${sessionScope.onlineUser.isHigherEqualThanMANAGER}">
				<select class="btn btn-default" name="difficulty"
