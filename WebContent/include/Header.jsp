...
<ul id="nav" style="display: none;">
	...
	<li><a href="#">
			<fmt:message key="LANGUAGE" />(${sessionScope.session_locale})
		</a>
		<ul>
			...
			<c:if test="${sessionScope.onlineUser.isHigherEqualThanMANAGER}">
				<li><a href="#">站務管理</a>
					<ul>
						...
						<li><a href="./EditContests">管理測驗/競賽</a></li>
 ...
 --%>
				<ul id="menu">
					...
					<li><a href="./ShowIMessages?action=inboxIM">xxx <fmt:message
					...
					<c:if test="${sessionScope.onlineUser.contestManager}">
						<li><a href="./EditContests">測驗/競賽管理</a></li>
					</c:if>
					...
					<c:if test="${sessionScope.onlineUser.VClassManager}">
						<li><a href="./ShowVClasses">課程管理</a></li>
					</c:if>
					<c:if
					...
					<c:if test="${sessionScope.onlineUser.isDEBUGGER}">
						<li><a href="#">Debug</a>
							<ul>
								...
								<li><a href="./ShowVClasses">管理課程</a></li>
