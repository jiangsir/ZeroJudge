...
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet"> 
 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/jscripts/bootstrap-3.3.7-dist/css/bootstrap.min.css">
...
<link
	...
	rel="stylesheet">
-->
<link rel="stylesheet" href="${pageContext.request.contextPath}/jscripts/font-awesome-4.7.0/css/font-awesome.min.css">

<!-- 
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap3-dialog/1.34.7/css/bootstrap-dialog.min.css" rel="stylesheet">
 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/jscripts/bootstrap3-dialog/bootstrap-dialog.min.css">

<!-- 
<link rel="stylesheet"
	href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.10.0/styles/default.min.css">
 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/jscripts/highlight.js/default.min.css">

<!-- </Bootstrap CDN>  -->


<link href="${pageContext.request.contextPath}/jscripts/bootstrap-flat-3.3.4-dist/docs.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/jscripts/bootstrap-flat-3.3.4-dist/docs-flat.css" rel="stylesheet">


<!-- <script
	src=https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js></script>
 -->
<script src="${pageContext.request.contextPath}/jscripts/jquery-1.11.3.min.js"></script>
...
<!-- <script src="//code.jquery.com/ui/1.11.1/jquery-ui.js"></script>
 -->
<script src="${pageContext.request.contextPath}/jscripts/jquery-ui-1.11.4/jquery-ui.js"></script>

<!-- <script
	src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>
 -->
<script src="${pageContext.request.contextPath}/jscripts/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
...
<!-- <script
 ...
 -->
<script src="${pageContext.request.contextPath}/jscripts/bootstrap3-dialog/bootstrap-dialog.min.js"></script>
...
<!-- <script
 ...
 -->
<script src="${pageContext.request.contextPath}/jscripts/highlight.js/highlight.min.js"></script>
