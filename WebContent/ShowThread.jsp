...
<script type="text/javascript" src="./include/ForumToolbar.js"></script>
</head>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<div class="panel-title">
								...
								<jsp:include page="include/div/ArticleTitle_Type2.jsp" />
							</div>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-sm-6 col-md-3">
									<div class="thumbnail">
										<c:set var="user" value="${article.user}" scope="request" />
										<jsp:include page="include/div/UserStatisticInfo.jsp" /></div>
								</div>
								<div class="col-md-9 clearfix">
									<div style="float: right;">
										<c:set var="problem" value="${article.problem}"
											scope="request" />
									...
									<c:set var="article" value="${article}" scope="request" />
									<c:set var="origid" value="${param.reply}" />
									<c:if test="${param.reply==0}">
						...
						<div class="panel-footer clearfix">
							<jsp:include page="include/ForumToolbar.jsp">
