			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td><a name="Samplecode"></a> <jsp:include
							page="include/div/ShowServerConfig.jsp" />
						<table class="table table-hover" title="${latestsolutions[0].id-countsolutions}">
							<c:forEach var="solution" items="${latestsolutions}"
								varStatus="varstatus">
								<tr>
									<td>${solution.id}</td>
									...
									<td><jsp:include page="include/div/SolutionCode.jsp" /></td>
									<td><fmt:formatDate value="${solution.submittime}"
						...
						<div>
							Version: <br>
							ZeroJudge: ${applicationScope.version}<br>
							JudgeServer: ${applicationScope.appConfig.serverConfig.version} |
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td valign="top">&nbsp;</td>
					<td><p>ZeroJudge 是一個 Online Judge
							系統亦即線上解題系統，中文來說有許許多多不同的翻譯名詞，諸如：在線裁決系統、在線評判系統、在線提交系統...等等不一而足，建議還是直接稱呼
							Online Judge
							系統。主要是用來讓有意練習程式語言的人士(主要是學生)，有一些題目可以練習，並且可以知道自己所寫的程式是不是正確。</p>
						<p>
							目前世界上最著名的 Online Judge 便是大名鼎鼎的 UVa Online Judge
							System，沒聽過？那是因為大家都叫他 ACM。至於其中原因請參考 DJWS 所寫的『<a
								...
								href="http://online-judge.uva.es/problemset/" target="_blank">http://online-judge.uva.es/problemset/</a>)所維護，目前已經有2000個題目，讓全世界的程式愛好者們想辦法去解決，這是全世界對寫程式有興趣的人一個練習的好地方。
						</p>
						<p>
							然而，UVa(ACM)題目大多數都是需要用到許多演算法及程式技巧，對於中上程度的程式學習者具有很好的練習效果，但對於初學者，可就會覺得障礙連連，深受打擊了。</p>
						<p>
							作者(Jiangsir)所服務學校(國立高雄師大附中)練習程式設計的學生也遭遇類似的情況，因此曾積極尋找備有初級題目的
							Online Judge
							系統(首先排除國外網站，因為語言障礙足以擊退絕大多數初學者)，可惜無法如願，並且發現此時(2006)國內各大學尚未具備公開上線，可供自由練習的
							Online Judge 系統。也曾嘗試考慮北京大學開發的(Peking
							JudgeOnline)，但該系統並未開放原始碼許多功能無法動手修改。最後終於決定自行開發，於是 ZeroJudge
							計畫誕生，代表從零開始。</p>
						<p>大事紀：</p>
						<ul>
							<li>94學年度首度運用在學生課堂程式考試上，該版本為手動驗證，由人工判斷程式是否正確，此時僅為一個線上測驗系統。</li>
							<li>2006年中，改寫整個操作模式，使其朝向 Online Judge 架構發展，仍應用於程式考試上。</li>
							<li>同年，完成自動裁判服務 (Judge Server)，可判斷出 Accept, Wrong Answer,
								Time Limit Exceed, Runtime Error, Restricted Functions, Compile
								Error, System Error...等狀態，至此可算是一個初步堪用的 Online Judge 系統。</li>
							<li>2007年初，公開上線供公眾練習使用，同時借此檢驗系統穩定度，並逐步發掘問題，逐步修正。</li>
							<li>2007年中，發展完成多重判決(分段計分)及條件式判決(Special
								Judge)，因此可以正確判定可列舉的多重解答以及難以列舉或甚至無法列舉，但有規則可循的不特定測資。</li>
							<li>2007年底，獲教育部全國校園軟體創意競賽 教學應用及自由創意組 第二名。</li>
							<li>2008年初，實作完成多人管理模式，使用者可增加題目及舉辦考試，正式具備使用者參與的特性。</li>
							<li>2008年底，舉辦第一屆海峽兩岸青少年程式設計競賽。</li>
							<li>2009年，獲得教育部『國際大專院校程式設計推廣與培訓計劃』採用作為解題平臺，網址： <a
								href="http://140.122.185.166/ZeroJudge/">
									http://ptc.moe.edu.tw/ </a> 。
							</li>
							<li>2010年，獲『高雄市資訊學科能力競賽複賽』採用作為正式競賽系統。</li>
							<li>2011年，提交之程式碼突破 100 萬筆。題目數量突破 1000 題。</li>
							<li>2014年，提交之程式碼達到 200 萬筆。</li>
							<li>2016年，提交之程式碼達到 300 萬筆。</li>
							<li>2017年，ZeroJudge 虛擬機版本開始提供下載測試。</li>
							<li>2020年，APCS 程式練習網上線<a
								href="https://apcsclass.csie.ntnu.edu.tw">
									https://apcsclass.csie.ntnu.edu.tw </a></li>
						</ul></td>
				</tr>
			</table>
		</div>
