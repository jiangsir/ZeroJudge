...
<script type="text/javascript" src="include/dialog/VClass.js?${applicationScope.built}"></script>
<script type="text/javascript" src="include/div/VclassCode.js?${applicationScope.built}"></script>
<script type="text/javascript" src="ShowVClasses.js?${applicationScope.built}"></script>
<script type="text/javascript" src="EditVClasses.js?${applicationScope.built}"></script>
					...
					<table class="table table-hover">
						...
						<c:forEach var="vclass" items="${joined_vclasses}">
							<tr>
								...
								<td><a href="./ShowVClass?vclassid=${vclass.id}">
										<c:if test="${vclass.visible==0}">
											<del>${vclass.vclassname}</del>
										</c:if>
										<c:if test="${vclass.visible!=0}">${vclass.vclassname}</c:if>
									</a>
									<%-- <c:set var="vclass" value="${vclass }" scope="request" />
								...
								<td>
									...
									<c:if test="${vclass.visible!=0}">${vclass.descript}</c:if>
								</td>
								<td>
