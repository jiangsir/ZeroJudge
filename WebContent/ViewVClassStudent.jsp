	...
	<div class="content_individual">
		<table width="80%" border="0" align="center">
			...
			<tr>
				...
				<td valign="top" style="font-family: Consolas, 'Courier New', monospace;"><c:choose>
					...
					<hr /> * 本統計表的題目僅記錄本課程當中所有使用過的題目<br /> * 在本課程所進行的&quot;<fmt:message
						key="Contest.VContest" />&quot;過程當中答對的題目才列入統計，在平常練習當中答對者並不會列入統計，請注意。</td>
			</tr>
		</table>
	</div>
