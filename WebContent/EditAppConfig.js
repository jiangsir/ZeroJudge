...
jQuery(document).ready(
		function() {
			...
			jQuery("input[name=enableMailer]").each(function() {
				console.log("data:enableMailer"+$(this).data("enableMailer"));
				console.log("attr:enableMailer="+ $(this).attr("data-enableMailer"));
				
				var enableMailer = $(this).attr("data-enableMailer");
			...
			jQuery("input[name=enableReCaptcha]").each(function() {
				console.log("data:enableReCaptcha="+$(this).data("enableReCaptcha"));
				console.log("attr:enableReCaptcha="+ $(this).attr("data-enableReCaptcha"));
				
				var enableReCaptcha = $(this).attr("data-enableReCaptcha");
...
function click_enableMailer(enableMailer){
    if (enableMailer.is(":checked")) {
    	...
    	//enableReCaptcha.closest(".form-group").find("input[name=site_key]").prop('disabled', false);
    	//enableReCaptcha.closest(".form-group").find("input[name=secret_key]").prop('disabled', false);
    } else {
    	...
    	//enableReCaptcha.closest(".form-group").find("input[name=site_key]").prop('disabled', true);
    	//enableReCaptcha.closest(".form-group").find("input[name=secret_key]").prop('disabled', true);
    }	
}
...
function click_enableGoogleLogin(enableGoogleLogin){
    if (enableGoogleLogin.is(":checked")) {
    	...
    	//enableGoogleLogin.closest(".form-group").find("input[name=client_id]").prop('disabled', false);
    	//enableGoogleLogin.closest(".form-group").find("input[name=client_secret]").prop('disabled', false);
    } else {
    	...
    	//enableGoogleLogin.closest(".form-group").find("input[name=client_id]").prop('disabled', true);
    	//enableGoogleLogin.closest(".form-group").find("input[name=client_secret]").prop('disabled', true);
    }	
}
