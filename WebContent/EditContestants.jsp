							...
							<div class="btn-group btn-group-sm" role="group">
								...
								<div class="btn-group btn-group-sm" role="group"
									...
									<button type="button" class="btn btn-default"
										data-target="#Modal_confirm" title="回復使用者 重新加入測驗"
										data-title="回復使用者 重新加入測驗"
										data-content="回復 ${contestant.user.account} 將可以重新進行競賽，確定嗎？"
						...
						<td width="20%">
							<div class="btn-group btn-group-sm" role="group" aria-label="...">
								<button type="button" class="btn btn-default"
									...
									data-title="將使用者踢出測驗"
									data-content="使用者將從排行榜中除名，且無法自行再加入競賽。確定踢出 （${contestant.user.account}）？"
									data-type="POST" data-url="Contest.api"
