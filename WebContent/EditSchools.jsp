...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="contestbox">
				<p>* 學校名稱及資料必須經由管理員確認過後才會出現在『學校清單』中。</p>
			</div>
			<hr></hr>
 ...
 --%>
			...
			<table class="table table-hover">
				<tr>
					<th class="text-center">學校id (schoolid)</th>
					<th style="text-align: left;">學校</th>
				</tr>
				<c:forEach var="school" items="${schools}">
					<tr>
						<td class="text-center">${school.id}</td>
						<td id="${school.id}"><span style="float: left"> <a
								href="./Ranking?tab=tab03&schoolid=${school.id}">${fn:escapeXml(school.schoolname)}</a>
