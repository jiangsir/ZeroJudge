...
<body>
				...
				<c:forEach var="onlineUserSessionScope"
					...
					<tr>
						...
						<td><c:set var="user"
							...
							<jsp:include page="include/div/UserAccount.jsp" /></td>
						<td>
 ...
 --%> <%-- <a
						...
						<td><a
							href="ShowContest?contestid=${onlineUserSessionScope.onlineUser.joinedcontestid}">${onlineUserSessionScope.onlineUser.joinedcontestid}</a></td>
						<td><fmt:formatNumber
