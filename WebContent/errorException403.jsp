...
<body>
	...
	<div class="content_individual">
		<div style="font-size: large">
			您所使用的 IP(${pageContext.request.remoteAddr}) 可能因連線過多而被封鎖！<br /> Your
			IP(${pageContext.request.remoteAddr}) may be denied by our system
			because of too many connections!<br /> <br /> 若對此訊息有疑問，請通知管理員！謝謝！<a
				href="mailto:${applicationScope.appConfig.systemMail}">${applicationScope.appConfig.systemMail}</a><br />
		</div>
		<p>
